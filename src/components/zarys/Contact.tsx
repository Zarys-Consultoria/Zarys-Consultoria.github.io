        ...
        <Reveal>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="mt-6 text-lg text-muted-foreground leading-relaxed">
              Estamos prontos para construir o futuro com você. Escolha o canal
              que preferir e dê o primeiro passo.
            </p>
          ...
          {channels.map((c, i) => (
            <Reveal key={c.label} delay={i * 120}>
              <a
                ...
                className="group flex h-full flex-col rounded-2xl bg-card border border-border p-8 hover:shadow-elegant hover:-translate-y-1 transition-all duration-300"
              >
                ...
                <span className="mt-6 text-xs uppercase tracking-[0.2em] text-muted-foreground font-semibold">
                  {c.label}
                </span>
